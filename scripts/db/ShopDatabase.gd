...
const SHOPS := {
	"yuheng_pharmacy": {
		...
		"items": [
			...
			{"item_id": "med_smoke_sand", "price": 20, "stock": -1},
			{"item_id": "med_binding_resin", "price": 24, "stock": -1},
			{"item_id": "med_focus_powder", "price": 22, "stock": -1},
	...
	"yuheng_weapon_shop": {
		...
		"items": [
			...
			{"item_id": "arm_leather_cloth", "price": 50, "stock": -1},
			{"item_id": "cloth_gloves", "price": 5, "stock": -1},
			{"item_id": "leather_gloves", "price": 10, "stock": -1},
