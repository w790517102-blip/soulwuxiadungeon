...
const SKILLS := {
	...
	"skill_qihui_talisman": {
		...
		"name": "臨符・啟慧",
		"category": "單體增益",
		"description": "書眠凝神落筆，畫下啟慧之符，使目標思緒清明，智慧提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "focus",
		"effects": [{"type": "stat_buff", "stat": "int", "amount": 10, "turns": 3, "apply_log": "書眠臨空畫下啟慧符，符光入心，目標心念澄明。"}],
	...
	"skill_jufu_talisman": {
		...
		"name": "臨符・聚福",
		"category": "單體增益",
		"description": "書眠以朱砂成符，聚一縷福意於目標身側，使幸運提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "fortune",
		"effects": [{"type": "stat_buff", "stat": "luck", "amount": 10, "turns": 3, "apply_log": "書眠落筆成符，福光微聚，目標的運勢提升了。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
	"skill_linfu_ranfeng": {
		"id": "skill_linfu_ranfeng",
		"name": "臨符・燃鋒",
		"category": "單體增益",
		"description": "書眠畫下燃鋒之符，使符火附於招式之上，攻擊力提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "focus",
		"effects": [{"type": "atk_up", "amount": 15, "turns": 3, "apply_log": "烈火符光燃起，攻勢隨焰勢暴漲。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
	"skill_linfu_guyuan": {
		"id": "skill_linfu_guyuan",
		"name": "臨符・固元",
		"category": "單體增益",
		"description": "書眠畫下固元之符，穩住目標氣血根基，使體能提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "focus",
		"effects": [{"type": "stat_buff", "stat": "con", "amount": 10, "turns": 3, "apply_log": "書眠筆鋒沉穩，固元符光護住經脈，目標體能提升了。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
	"skill_linfu_jiying": {
		"id": "skill_linfu_jiying",
		"name": "臨符・疾影",
		"category": "單體增益",
		"description": "書眠筆鋒一轉，畫下疾影之符，使目標身法變得輕快。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "mobility",
		"effects": [{"type": "stat_buff", "stat": "agi", "amount": 10, "turns": 3, "apply_log": "疾影符光掠過足下，目標身形變得輕靈。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
	"skill_linfu_zhuangli": {
		"id": "skill_linfu_zhuangli",
		"name": "臨符・壯力",
		"category": "單體增益",
		"description": "書眠畫下壯力之符，使目標筋骨一振，力量提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "focus",
		"effects": [{"type": "stat_buff", "stat": "str", "amount": 10, "turns": 3, "apply_log": "壯力符光沒入臂骨，目標力量提升了。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
	"skill_linfu_humai": {
		"id": "skill_linfu_humai",
		"name": "臨符・護脈",
		"category": "單體增益",
		"description": "書眠畫符護住經脈，使目標防禦提升。",
		"weapon_type": "筆",
		"menu_usable": false,
		"mp_cost": 7,
		"target_scope": "single",
		...
		"positive_buff": true,
		"buff_theme": "focus",
		"effects": [{"type": "def_up", "amount": 15, "turns": 3, "apply_log": "護脈符光沿經絡流轉，目標防禦提升了。"}],
		"available": {"mode": "include", "actor_ids": ["shumian"]},
	},
...
const LEGACY_NAME_TO_ID := {
	...
	"臨符・啟慧": "skill_qihui_talisman",
	"臨符・聚福": "skill_jufu_talisman",
	"臨符・燃鋒": "skill_linfu_ranfeng",
	"臨符・固元": "skill_linfu_guyuan",
	"臨符・疾影": "skill_linfu_jiying",
	"臨符・壯力": "skill_linfu_zhuangli",
	"臨符・護脈": "skill_linfu_humai",
...
const DEFAULT_SKILL_IDS_BY_ACTOR := {
	...
	"shumian": ["skill_bisaoyanxia", "skill_luobichengshi", "skill_zhengxinquan", "skill_buff_speed_test", "skill_qihui_talisman", "skill_jufu_talisman", "skill_linfu_ranfeng", "skill_linfu_guyuan", "skill_linfu_jiying", "skill_linfu_zhuangli", "skill_linfu_humai", "skill_debuff_speed_test", "skill_force_element_test", "skill_smoky_ink_blind", "skill_hawkeye_focus", "skill_mobishuxin", "skill_inkveil_swiftroute"],
