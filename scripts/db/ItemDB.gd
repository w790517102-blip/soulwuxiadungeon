...
const ITEM_DEFS := {
	...
	"arm_boss_running_shoes": {"name": "老闆的跑鞋", "desc": "鐵匠老闆私藏的跑鞋，穿上後腳步輕快，特別適合測試閃避。", "type": "equipment", "use_scope": "world", "use_action": "equip", "equip_slot": "armor_feet", "stats": {"speed": 3, "evasion": 35}},
