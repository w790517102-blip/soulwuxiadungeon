...
const ITEM_DEFS := {
	...
	"quest_green_beans_raw": {"name": "生四季豆", "desc": "阿茂菜攤買來的生四季豆。", "type": "quest", "use_scope": "none", "use_action": "none"},
	"quest_green_beans_fried": {"name": "炸熟四季豆", "desc": "炸過一遍、可直接再料理上桌的四季豆。", "type": "quest", "use_scope": "none", "use_action": "none"},
