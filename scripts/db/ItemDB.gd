...
const ITEM_DEFS := {
	...
	"tea_snack_hp": {"name": "玲瓏酥", "desc": "小巧精緻的茶席點心，外皮酥鬆，內餡細甜，入口不膩。雖只是一口大小，卻最能在氣力將盡時，替人把散掉的精神重新攏回來。", "type": "consumable", "use_scope": "world", "use_action": "consume", "effect": "heal_by_stat", "stat_key": "agi", "base_amount": 10, "scale": 2, "min_amount": 10, "max_amount": 80, "target_scope": "ally_single"},
