		...
		"debuff_speed": {
			...
			"shumian": "書眠指尖一彈，細碎機括像散墨般飛出，把對方的腳步牢牢牽住。"
                ...
                "haste_talisman": {
                        ...
                        "default": "當他從行囊中取出那枚奇物時，四周空氣像被扯動，數道疾風在身側盤旋而起，連戰局的節奏都跟著一偏。",
                        # 劉語塵：偏出手、牽動風勢，不講是貼自己還是丟敵人
                        "liuyu": "劉語塵指尖一翻，那奇物被真氣催亮，被青光照耀的瞬間也不自覺輕了起來。",
                        # 書眠：她是「送出去」那個人，符光像紙鷂／墨痕滑行
                        "shumian": "那枚奇物夾在書眠纖細的指間，就在她舉手的那一霎那，靈光灑落在眾人的腳上。",
                        # 列肖：用琴當發射器，把「速度」丟進樂句裡
                        "lieshao": "列肖將那枚奇物按壓在琴弦上，指尖一撥，符紋隨弦音震盪飛出，腳步也隨著音律輕了起來。"
                },
                "fire_talisman_ally": {
