...
var yuheng_market_east: String = "res://scenes/yuheng/yuheng_market_east/yuheng_market_east.tscn"
@onready var overlay := $BlackOverlay
@export var music_tag := "ZueYue_teashop"
@export var map_display_name: String = "醉月茶坊"
...
func _on_to_yuheng_market_east_body_entered(body: Node2D):
	if body.name == "LiuYu":
		...
		get_node("/root/GameRoot").spawn_point_name = "from_ZueYue_teashop"
