...
func _ready():
	...
	dialog_lines = [
		{ "text": "「左飲那孩子啊，從小就懂得忍氣吞聲。要不是他，這鎮早被亂事拖垮了」", "speaker": speaker_id, "portrait": portrait_path },
		{ "text": "「他總說『保一地安寧，不須千人喝采』，像不像傻？可我敬他。」", "speaker": speaker_id, "portrait": portrait_path },
	]
