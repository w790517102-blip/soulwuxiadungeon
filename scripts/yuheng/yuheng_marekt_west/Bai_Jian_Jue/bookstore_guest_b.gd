...
func _build_lines_for_stage(main_stage: int) -> Array:
	var met := GlobalState.get_flag("met_bai_jian_jue_guestB")
	...
	if not met:
		return [
		{ "text": "「玉衡鎮四大名產:茶、酒、琴、書」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「書指的就是這間白箋居裡的詩句詞本，皆出自於當家——書眠之手」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「只是……唉，她以前常常寫，現在一本新詩都等不上……」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「也不是說她懶，只是這幾年啊，寫出來的句子總覺得少了什麼……」", "speaker": 1, "portrait": portrait_path },
		{ "text": "劉語塵：「你的意思是她已江郎才盡?」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "「是我們鎮上太安靜了……靜得像沒人有心事。可哪有人真的沒心事呢？」", "speaker": 1, "portrait": portrait_path },
		{ "text": "劉語塵：「此話怎說? 她的詩和你們的心事有何關聯?」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "「書眠姑娘的詩能夠撼動人心，靠得不是華麗艱澀的詞藻」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「而是她總能夠一語中的的寫出你心中想言卻不知從何說起的苦楚與歡笑」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「就好像那首詩在對你說『我懂你』似的。」", "speaker": 1, "portrait": portrait_path },
		{ "text": "劉語塵：「也就是現在的詩明明能夠道出你們的心聲」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "劉語塵：「但你們卻覺得『即使沒有道出心聲也無所謂』，這樣?」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "「唉…正是如此。」", "speaker": 1, "portrait": portrait_path },
		{ "text": "劉語塵：「那這樣看起來比起此地的來客，更感到更難過應是\n書眠姑娘吧…」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "劉語塵：「那種嘔心瀝血寫出作品，卻不被人在乎的那種寂寞感…」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
		{ "text": "(慌張地將食指放置自己的嘴巴前)「噓!小聲點!」", "speaker": 1, "portrait": portrait_path },
		{ "text": "「講這麼大聲要是傷到人家小姑娘的心就不好了!」", "speaker": 1, "portrait": portrait_path },
		{ "text": "劉語塵：「…」", "speaker": 2, "portrait": "res://assets/sprites/Liu_Yu/LiuYu_headshot.png" },
	]

	if main_stage <= 2:
			return [
				{ "text": "「只盼鎮上的人能夠找回當初讀書眠詩句時的那份感動…」", "speaker": 1, "portrait": portrait_path },
...
func _unhandled_input(event):
	...
	if event is InputEventKey and event.pressed and event.keycode == KEY_SPACE:
		...
		_mark_flag_after_close = not GlobalState.get_flag("met_bai_jian_jue_guestB")

func reset_dialog_state():
	get_node("/root/GameRoot/LiuYu").can_move = true
	is_talking = false
	if _mark_flag_after_close:
		GlobalState.set_flag("met_bai_jian_jue_guestB", true)
