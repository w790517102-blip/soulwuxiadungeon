...
func _ready():
	...
	dialog_lines = [
		{ "text": "「左飲啊……我記得他年輕時不是這樣冷臉的，以前還會幫人挑水呢。」", "speaker": speaker_id, "portrait": portrait_path },
		{ "text": "「聽說他當年欠了書眠姑娘一命，所以才會在她開白箋居時幫了不少忙。」", "speaker": speaker_id, "portrait": portrait_path },
	]
