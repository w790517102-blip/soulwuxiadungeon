...
func _ready():
	...
	dialog_lines = [
		{ "text": "「只要聽過西街那邊的琴聲，一整天內心都會很平靜。」", "speaker": speaker_id, "portrait": portrait_path },
		{ "text": "「即使人已經離開那邊也一樣。」", "speaker": speaker_id, "portrait": portrait_path },
		{ "text": "「那琴聲就是有如此魔力。」", "speaker": speaker_id, "portrait": portrait_path },
	]
